...
async def update_invoice(
    ...
    update_data = {
        ...
        "subtitle": invoice_data.get('subtitle', invoice.get('subtitle')),
...
async def create_cost_estimate(
    ...
    estimate_doc = {
        ...
        "b2b_ohsms_percentage": estimate_data.b2b_ohsms_percentage,
        "b2b_ohsms_labor_percentage": estimate_data.b2b_ohsms_labor_percentage,
        "b2b_subcontractor_percentage": estimate_data.b2b_subcontractor_percentage,
        ...
        "include_profit": estimate_data.include_profit,
        "include_overhead": estimate_data.include_overhead,
        "include_cfse": estimate_data.include_cfse,
        "include_liability": estimate_data.include_liability,
        "include_municipal_patent": estimate_data.include_municipal_patent,
        "include_contingency": estimate_data.include_contingency,
        "include_b2b_ohsms": estimate_data.include_b2b_ohsms,
        "include_b2b_ohsms_labor": estimate_data.include_b2b_ohsms_labor,
        "include_b2b_subcontractor": estimate_data.include_b2b_subcontractor,
...
async def convert_cost_estimate_to_estimate(
    ...
    estimate_doc = {
        "estimate_id": new_estimate_id,
        "estimate_number": estimate_number,
        "project_id": cost_estimate.get("project_id"),
        "project_name": project_name,
        "client_profile_id": None,
        "client_company": project.get("client_name", "") if project else "",
        "client_name": project.get("client_name", "Cliente") if project else "Cliente",
        "client_email": None,
        "client_phone": None,
        "client_address": None,
